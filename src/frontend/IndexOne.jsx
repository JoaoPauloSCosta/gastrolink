...
const IndexOne = () => {
  return (
    <>
        ...
        <div class="skeleton-loader">
            ...
            <section class="home-wrapper section-b-space">
                <div class="container text-center">
                    ...
                    <h2>Procurando deliciosos pratos na sua área...</h2>
                </div>
            </section>
                ...
                <ul class="home-features-list d-md-flex d-none">
                    <li>
                        <div class="home-features-box">
                            <img class="img-fluid icon" src="/src/assets/images/svg/routing.svg" alt="routing"/>
                            <h6>Wide Map</h6>
                        </div>
                    </li>
                    <li>
                        <div class="home-features-box">
                            <img class="img-fluid icon" src="/src/assets/images/svg/3d-rotate.svg" alt="3d-rotate"/>
                            <h6>Easiest Order</h6>
                        </div>
                    </li>
                    <li>
                        <div class="home-features-box">
                            <img class="img-fluid icon" src="/src/assets/images/svg/truck.svg" alt="truck"/>
                            <h6>Most Delivery</h6>
                        </div>
                    </li>
                </ul>
        ...
        <section class="categories-section section-b-space">
            <img src="/src/assets/images/scooter.png" class="scooter-img img-fluid d-md-inline-block d-none"
                ...
                <div class="theme-arrow">
                    <div class="swiper categories-slider categories-style">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant-listing.html" class="food-categories">
                                    <img class="img-fluid categories-img" src="/src/assets/images/product/p-3.png" alt="p-3"/>
                    ...
                    <div class="app-content">
                        ...
                        <div class="app-buttons d-flex align-items-center gap-3">
                            <a href="https://www.apple.com/in/app-store/">
                                <img class="img-fluid app-btn" src="/src/assets/images/svg/app-store.svg" alt="app-store"/>
                            </a>
                            <a href="https://play.google.com/store/apps">
                                <img class="img-fluid app-btn" src="/src/assets/images/svg/google-play.svg" alt="google-play"/>
                            </a>
                        </div>
                    </div>
                </div>
